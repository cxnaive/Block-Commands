...
public class CommandRemoveByPos extends CommandBase {
    ...
    public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
        ...
        try {
            ...
            sender.sendMessage(new TextComponentString("PosX,PosY,PosZ must be Intergers."));
            return;
        }
        ...
        if(data.getcommand(npos.toLong()) != null){
            ...
            sender.sendMessage(new TextComponentString("Successfully removed commands on block "+"X:"+npos.getX()+" Y:"+npos.getY()+" Z:"+npos.getZ()+"."));
        }
        else{
            sender.sendMessage(new TextComponentString("No commands on block"+"X:"+npos.getX()+" Y:"+npos.getY()+" Z:"+npos.getZ()+"."));
        }
